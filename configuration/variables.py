...
BOTCONTRIBUTOR = 711046740400406570 # The ID of the @Bot Contributor role.
...
MARIOCHAT = 549358054043418655 # The ID of the #mario-chat channel.
ZELDACHAT = 549358939150614548 # The ID of the #zelda-chat channel.
KIRBYCHAT = 549359271377108992 # The ID of the #kirby-chat channel.
FIREEMBLEMCHAT = 549359365736366114 # The ID of the #fire-emblem-chat channel.
ANIMALCROSSINGCHAT = 549359365736366114 # The ID of the #animal-crossing-chat channel.
SPLATOONCHAT = 549359389749018624 # The ID of the #splatoon-chat channel.
DIRECTCHAT = 599480082247057408 # The ID of the #direct-chat text channel.
...
NITROBOOSTERCHAT = 616372636137554050 # The ID of the #nitro-booster-chat text channel.
CHAMPIONCHAT = 601553721406783499 # The ID of the #champion-chat text channel.
AMBASSADORCHAT = 461034857531703317 # The ID of the #ambassador-chat text channel.
AFFILIATECHAT = 491018259672465428 # The ID of the #affiliate-chat text channel.
MODERATORCHAT = 478388911350087709 # The ID of the #moderator-chat text channel.
NITROBOOSTERCHATV = 617748679767490570 # The ID of the Nitro Booster Chat voice channel.
CHAMPIONCHATV = 601554333049421827 # The ID of the Champion Chat voice channel.
AMBASSADORCHATV = 461035464242102283 # The ID of the Ambassador Chat voice channel.
AFFILIATECHATV = 491022905916915723 # The ID of the Affiliate Chat voice channel.
